...
and generate an SPDX SBOM per archive.
...
generated by [syft](https://github.com/anchore/syft)) listing everything
bundled in it. This is independent of the cosign signing above: it does not
feed the self-updater's trust chain, which still relies solely on
